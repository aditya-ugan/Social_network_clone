...
"""
Django settings for travellite project.
...
SECRET_KEY = ')(+7w7*a^*ta=n6f*b-gfc=pk3q^$xb+%w&77k!y@(55&i6$p%'
...
ROOT_URLCONF = 'travellite.urls'



WSGI_APPLICATION = 'travellite.wsgi.application'
...
STATICFILES_DIRS = (
    os.path.join(BASE_DIR, 'travellite', 'static'),
)
SITE_ID = 1
...
TEMPLATES = [
    {
        ...
        'DIRS': [os.path.join(BASE_DIR, 'travellite', 'templates'),],
        'OPTIONS': {
            'context_processors': [
